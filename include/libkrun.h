 ...
 * matches an explicit CIDR, a periodically refreshed allowed-host DNS answer,
 * or an IP learned from an allowed guest DNS response. All other egress is
 * denied at the TSI muxer layer.
 *
 * Arguments:
 *  "ctx_id"         - the configuration context ID.
